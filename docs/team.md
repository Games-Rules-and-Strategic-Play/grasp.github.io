...
<div style="display: flex; align-items: flex-start; margin-bottom: 30px;">
  <img src="../images/eric_gottlieb.jpg" style="width: 110px; height: 110px; border-radius: 50%; object-fit: cover; margin-right: 20px; flex-shrink: 0; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
  <div>
...
<div style="display: flex; align-items: flex-start; margin-bottom: 30px;">
  <img src="../images/peter_mursic.webp" style="width: 110px; height: 110px; border-radius: 50%; object-fit: cover; margin-right: 20px; flex-shrink: 0; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
  <div>
...
* [Andres David Santamaria-Galvis](https://sites.google.com/view/adsantamaria/home) (UL IMFM)
